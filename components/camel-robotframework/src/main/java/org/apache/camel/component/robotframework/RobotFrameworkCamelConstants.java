...
public interface RobotFrameworkCamelConstants {
    ...
    public final String ROBOT_VAR_CAMEL_BODY = "body";
    public final String ROBOT_VAR_CAMEL_HEADERS = "headers";
    public final String ROBOT_VAR_CAMEL_PROPERTIES = "properties";
    public final String ROBOT_VAR_FIELD_SEPERATOR = ":";
    public final String ROBOT_VAR_NESTING_SEPERATOR = ".";
