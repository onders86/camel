    ...
    public void testCreateRobotVariablesFromCamelExchange() throws Exception {
        ...
        for (String camelRobotVariable : camelRobotVariables) {
            ...
            if (camelRobotVariable.contains("headers") && camelRobotVariable.contains("innerNumericBigDecimalKey")) {
                assertEquals("Header variable content should be [headers.numericIntKey:<header_value>]", "headers.inner.numericBigDecimalKey:2", camelRobotVariable);
            }
            ...
            if (camelRobotVariable.contains("properties") && camelRobotVariable.contains("innerNumericBigDecimalKey")) {
                assertEquals("Header variable content should be [properties.numericIntKey:<header_value>]", "properties.inner.numericBigDecimalKey:2", camelRobotVariable);
            }
        }
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("direct:setVariableCamelExchange").to("robotframework:src/test/resources/org/apache/camel/component/robotframework/set_variable_camel_exchange.robot")
                    .to("mock:result");
            }
        };
    }
